...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
      throws IOException {
    if (model == Model.QUANTIZED_FACEMASK) {
      return new ClassifierQuantizedFaceMask(activity, device, numThreads);
    } else if (model == Model.FLOAT_FACEMASK) {
      return new ClassifierFloatFaceMask(activity, device, numThreads);
